...
$$ {#eq-1}
The cdf associated with \eqref{eq-1} is given by
$$
  F(x) = \frac{1}{\pi}\arctan(x) + \frac{1}{2}.
$${#eq-2}


**Part a.**  We apply the inversion method as described by @graham2013stochastic. We first compute the generalised inverse of the cdf \eqref{eq-2}.  To this end, let $y\in [0,1]$, then
